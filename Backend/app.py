...
try:
    mean_shift_model = joblib.load('mean_shift_model.pkl')  # Only loading the MeanShift model
...
def get_food_recommendations(target_calories):
    ...
    for meal, meal_calories in calorie_distribution.items():
        ...
        meal_recommendations = [
            {
                "name": recipe['name'],
                "ingredients": recipe.get('ingredients', ''),  # Assuming you have an 'ingredients' column
                "steps": recipe.get('steps', ''),              # Assuming you have a 'steps' column
                "description": recipe.get('description', ''),  # Assuming you have a 'description' column
                "nutrition": {
